              ...
              children: <Widget>[
                Flexible(
                  child: AnimatedContainer(
                    ...
                    width: isFocused ? widthMax * .8 : widthMax,
                ...
                GestureDetector(
                  ...
                  child: AnimatedOpacity(
                    ...
                    curve: Curves.easeIn,
                    duration: Duration(milliseconds: isFocused ? 1000 : 0),
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 100),
                      width:
                      isFocused ? MediaQuery.of(context).size.width * .2 : 0,
                      child: Container(
