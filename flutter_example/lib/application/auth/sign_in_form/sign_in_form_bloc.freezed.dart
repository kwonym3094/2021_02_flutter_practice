...
mixin _$SignInFormState {
  ...
  Option<Either<AuthFailure, Unit>> get authFailureOrSuccessOption =>
      throw _privateConstructorUsedError; // user 가 signin button을 누르기 전까지는 값이 없음 => 불완전함 => Option type 추가
...
class _$_SignInFormState implements _SignInFormState {
  ...
  @override // user 가 signin button을 누르기 전까지는 값이 없음 => 불완전함 => Option type 추가
// Option : non-nullable type
// Unit : nullable type
//  - 둘 모두 null로 처리할 시 발생하는 오류를 잡기 위해 사용함
// Option<None,Some> // Either<Left, Right> 와 비슷함
